...
export default function SchedulePage() {
  ...
  return (
    <>
      <PageHeader
        title="Week Schedule"
        description="Create and publish weekly schedules."
      >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-7 gap-3 mt-3">
        {Array.from({length:7}).map((_,i) => {
          ...
          return (
            <div key={key} className="border rounded-xl p-3 bg-card">
              ...
              <div className="grid gap-2">
                {dayShifts.map(s => (
                  <div key={s.id} className="border rounded-lg p-2 text-xs bg-muted/50">
